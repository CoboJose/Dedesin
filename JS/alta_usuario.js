	...
	// EJERCICIO 3.1: Comprobar la restricciones del password y aplicar clases CSS mediante JQuery
		...
		if(!valid){
			var error = "Porfavor introducir una contraseña válida, tiene que tener 8 carácteres (Mayúsculas, minúsculas, letra y dígitos)";
		}else{			
			var error = "";
		}
	...
	function passwordConfirmation(){
		...
		var passconfirm = document.getElementById("#Confirmacion");
